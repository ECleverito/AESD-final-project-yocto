...
CORE_IMAGE_BASE_INSTALL += "libvisionworks-devso-symlink nvidia-docker cuda-libraries tensorrt-plugins-prebuilt python3-tensorrt python3-pytools tegra-mmapi-tests vpi1-tests tensorrt-tests"
